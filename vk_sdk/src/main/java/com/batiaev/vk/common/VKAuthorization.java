...
public class VKAuthorization {
    ...
    public String clientAuth() {
        ...
        String scope = "notify,friends,photos,audio,video,docs,notes,pages,status,offers,questions,wall,groups,messages,email,notifications,stats,ads,offline,market,+255";
