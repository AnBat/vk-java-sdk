...
public class VKApiUserConsts {
    public final static int FIELD_UID = "uid";
    ...
    public final static boolean FIELD_VERIFIED = "verified";
    public final static boolean FIELD_BLACKLISTED = "blacklisted";
    public final static int FIELD_SEX = "sex"; //{1 — female; 2 — male; 0 — not specified.}
    public final static String FIELD_BDATE = "bdate"; //DD.MM.YYYY or DD.MM (if birth year is hidden) or nothing if date is hidden
    public final static int FIELD_CITY = "city";
    public final static int FIELD_COUNTRY = "country";
    ...
    public final static boolean FIELD_ONLINE = "online";
    //sub
    public final static boolean FIELD_ONLINE_MOBILE = "online_mobile";
    public final static int FIELD_ONLINE_APP = "online_app";
    //end sub
    public final static String FIELD_LISTS = "lists"; //comma separated IDs
    public final static String FIELD_DOMAIN = "domain";
    public final static boolean FIELD_HAS_MODILE = "has_mobile";
    ...
    //sub
    public final static int FIELD_EDUCATION_UNIVERSITY = "university";
    public final static String FIELD_EDUCATION_UNIVERSITY_NAME = "university_name";
    public final static int FIELD_EDUCATION_FACULTY = "faculty";
    public final static String FIELD_EDUCATION_FACULTY_NAME = "faculty_name";
    public final static int FIELD_EDUCATION_GRADUATION = "graduation";
    //end sub
    public final static String FIELD_UNIVERSITIES = "universities";
    //sub
    public final static int FIELD_UNIVERSITIES_ID = "id";
    public final static int FIELD_UNIVERSITIES_COUNTRY = "country";
    public final static int FIELD_UNIVERSITIES_CITY = "city";
    public final static String FIELD_UNIVERSITIES_NAME = "name";
    public final static int FIELD_UNIVERSITIES_FACULTY = "faculty";
    public final static String FIELD_UNIVERSITIES_FACULTY_NAME = "faculty_name";
    public final static int FIELD_UNIVERSITIES_CHAIR = "chair";
    public final static String FIELD_UNIVERSITIES_CHAIR_NAME = "chair_name";
    public final static int FIELD_UNIVERSITIES_GRADUATION = "graduation";
    //end sub
    public final static String FIELD_SCHOOLS = "schools";
    //sub
    public final static int FIELD_SCHOOLS_ID = "id";
    public final static int FIELD_SCHOOLS_COUNTRY = "country";
    public final static int FIELD_SCHOOLS_CITY = "city";
    public final static String FIELD_SCHOOLS_NAME = "name";
    public final static int FIELD_SCHOOLS_YEAR_FROM = "year_from";
    public final static int FIELD_SCHOOLS_YEAR_TO = "year_to";
    public final static int FIELD_SCHOOLS_YEAR_GRADUATED = "year_graduated";
    public final static String FIELD_SCHOOLS_CLASS = "class";
    public final static String FIELD_SCHOOLS_SPECIALITY = "speciality";
    public final static int FIELD_SCHOOLS_TYPE = "type";
    public final static String FIELD_SCHOOLS_TYPE_STR = "type_str";
    //end sub
    public final static String FIELD_STATUS = "status";
    public final static String FIELD_LAST_SEEN = "last_seen";
    //sub
    public final static int FIELD_LAST_SEEN_TIME = "time"; //in Unix time
    public final static String FIELD_LAST_SEEN_PLATFORM = "platform";
    //end sub
    public final static int FIELD_FOLOWERS_COUNT = "followers_count";
    public final static int FIELD_COUNT = "common_count";
    public final static String FIELD_COUNTERS = "counters";
    //sub
    public final static int FIELD_COUNTERS_ALBUMS = "albums";
    public final static int FIELD_COUNTERS_VIDEOS = "videos";
    public final static int FIELD_COUNTERS_AUDIOS = "audios";
    public final static int FIELD_COUNTERS_NOTES = "notes";
    public final static int FIELD_COUNTERS_FRIENDS = "friends";
    public final static int FIELD_COUNTERS_GROUPS = "groups";
    public final static int FIELD_COUNTERS_ONLINE_FRIENDS = "online_friends";
    public final static int FIELD_COUNTERS_MANUAL_FRIENDS = "mutual_friends";
    public final static int FIELD_COUNTERS_USER_VIDEOS = "user_videos";
    public final static int FIELD_COUNTERS_FOLLOWERS = "followers";
    public final static int FIELD_COUNTERS_USER_PHOTOS = "user_photos"; //Fields returned only for desktop applications:
    public final static int FIELD_COUNTERS_SUBSCRIPTIONS = "subscriptions"; //Fields returned only for desktop applications:
    //end sub
    ...
    public final static int FIELD_OCCUPATION_ID = "id";
    ...
    //end sub
    public final static int FIELD_RELATION = "relation";
//    1 – single;
//    2 – in a relationship;
//    3 – engaged;
//    4 – married;
...
//    7 – in love.
    ...
    //sub
    public final static int FIELD_POLITICAL = "political";
//    1 – Communist;
//    2 – Socialist;
//    3 – Moderate;
//    4 – Liberal;
...
//    9 – Libertian.
    ...
    public final static int FIELD_PEOPLE_MAIN = "people_main";
...
//    6 – humor and love for life.
    public final static int FIELD_LIFE_MAIN = "life_main";
...
//    8 – fame and influence;
    public final static int FIELD_SMOKING = "smoking";
//    1 – very negative;
//    2 – negative;
//    3 – neutral;
//    4 – compromisable;
//    5 – positive.
    public final static int FIELD_ALCOHOL = "alcohol";
//    1 – very negative;
//    2 – negative;
//    3 – neutral;
//    4 – compromisable;
//    5 – positive.
    ...
    public final static int FIELD_WALL_COMMENTS = "wall_comments"; //{0,1}
    ...
    public final static boolean FIELD_CAN_POST = "can_post";
    public final static boolean FIELD_CAN_SEE_ALL_POSTS = "can_see_all_posts";
    public final static boolean FIELD_CAN_SEE_AUDIO = "can_see_audio";
    public final static boolean FIELD_CAN_WRITE_PRIVATE_MESSAGE = "can_write_private_message";
    public final static int FIELD_TIMEZONE = "timezone";
